export const registryConfig = {
   ...
   * @example "@smlee" - Users can install components with: `npx shadcn add @smlee/copy-button`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace: process.env.NEXT_PUBLIC_REGISTRY_NAMESPACE || "@smlee",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://smlee.info/r/{name}.json" resolves to "https://smlee.info/r/copy-button.json"
