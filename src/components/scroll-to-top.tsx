...
export function ScrollToTop({
  ...
  return (
    <Button
      ...
      className={cn(
        // On mobile the full-width bottom nav sits at the bottom edge, so lift
        // the button above it. There's no bottom nav from `sm` up.
        "[--bottom:4rem] sm:[--bottom:1rem] lg:[--bottom:2rem]",
